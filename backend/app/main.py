...
def load_models():
   encoder_path   = '/opt/ml/backend/model_save/encoder_all_260_1216_1424.pth'
   decoder_path   = '/opt/ml/backend/model_save/decoder_all_260_1216_1424.pth'
   generator_path = '/opt/ml/backend/model_save/pix2pixU.pth'
   fv_json_path   = '/opt/ml/backend/model_save/fv_all_train.json'
...
async def test(request: Request):
   ...
   save_image(inferenced_img, 'output.png')
   return {"hello": "world"}
