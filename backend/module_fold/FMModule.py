...
from module_fold.Block import ResnetBlock, ConvTrans2D_Block
...
class FMModule(nn.Module):
    def __init__(self, norm_layer, image_size, output_nc, latent_dim=512):
        ...
        # ConvTrans3
        self.convtr3_1 = ResnetBlock(256, padding_type=padding_type, activation=activation, norm_layer=norm_layer)
        self.convtr3_2 = ConvTrans2D_Block(256, 128, 4, 1, 2)

        # ConvTrans4
        self.convtr4_1 = ResnetBlock(128, padding_type=padding_type, activation=activation, norm_layer=norm_layer)
        self.convtr4_2 = ConvTrans2D_Block(128, 64, 4, 1, 2)

        # ConvTrans5
        self.convtr5_1 = ResnetBlock(64, padding_type=padding_type, activation=activation, norm_layer=norm_layer)
        self.convtr5_2 = ConvTrans2D_Block(64, 64, 4, 1, 2)

        # Lastlayer
        self.pad_1 = ResnetBlock(64, padding_type=padding_type, activation=activation, norm_layer=norm_layer)
