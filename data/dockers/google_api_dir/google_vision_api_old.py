...
class FaceDetector():
    ...
    def crop_faces_dir(self,src_dir,des_dir,maxnum):
        ...
        des_dir_annotationsx4 = os.path.join(des_dir,'annotationsx4')

        des_dir_annotations = os.path.join(des_dir,'annotations')

        if not os.path.exists(des_dir + '/anno'):
            os.makedirs(des_dir + '/anno')
        ...
        if not os.path.exists(des_dir_annotationsx4):

            os.makedirs(des_dir_annotationsx4)

        if not os.path.exists(des_dir_annotations):

            os.makedirs(des_dir_annotations)
        ...
        annotationsx4_file = open(des_dir+'/anno'+'/annotationsx4_file.txt','a')

        annotation_file = open(des_dir+'/anno'+'/annotation_file.txt','a')
        ...
        for f in files:
            ...
            if rect != None:
                ...
                des_file = os.path.join(des_dir_annotationsx4,des_file_name)
...
def main(argv):
    ...
    desdir = '/home/myamya/project/image_files'
