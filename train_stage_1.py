...
def get_time():
    d = datetime.now()
    return f'{d.month}{d.day}_{d.hour}{d.minute}'
...
def train(args):
    ...
    transform     = A.Compose([A.Blur(always_apply=False, p=0.5, blur_limit=(3, 4)),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_json', type=str, default='/opt/ml/project/data/train.json')
